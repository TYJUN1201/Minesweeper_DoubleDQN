...
def create_timestamp():
    return datetime.now(tz=None).strftime("%d-%b-%Y_%H-%M-%S")
...
ROWDIM = 9 # Number of rows in the Minesweeper grid
COLDIM = 9 # Number of columns in the Minesweeper grid
MINE_COUNT = 10
...
EXPERIENCE_REPLAY_BATCH_SIZE = 400
AGENT_MEMORY_LIMIT = EXPERIENCE_REPLAY_BATCH_SIZE*10
...
SOLVE_CONDITION = 80 # Average score training will stop at if reached
MOVING_AVE_WINDOW = 20 # Number of episodes to average over
...
for trial_index in range(NUMBER_OF_TRIALS):
    ...
    #online_network = load_model('model\Minesweeper_Online_0.9_batch128_27800+1200_episodes_31-Jul-2023_00-48-44.keras')  
    #target_network = load_model('model\Minesweeper_Target_0.9_batch128_27800+1200_episodes_31-Jul-2023_00-48-44.keras')  
    ...
    for episode_index in range(1, MAX_TRAINING_EPISODES+1):
        ...
        print('T %d E %d scored %d (%s), avg %.2f, avg q %.5f, epsilon %.2f, lr %.6E' \
    ...
    print(f"Time usage: {toc - tic:0.4f} seconds")
