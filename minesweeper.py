...
class Minesweeper:
    ...
    def init_gui(self):
        ...
        self.ui_height = 40 # Contains text regarding score and move #
    ...
    def render(self, valid_qvalues=np.array([])):
        ...
        self.gameDisplay.blit(text_move, (25, self.game_height+5))
        self.gameDisplay.blit(text_move_number, (120, self.game_height+5))        
        self.gameDisplay.blit(text_score, (150, self.game_height+5))
        self.gameDisplay.blit(text_score_number, (250, self.game_height+5))
        if self.done:
            if self.explosion:
