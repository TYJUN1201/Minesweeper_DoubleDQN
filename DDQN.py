...
class DoubleDQNAgent:
    ...
    def save_model_to_disk(self, env, numeps, timestamp):
        self.online_network.save('model/' + env + '_Online_0.9_batch128_29000+' + numeps +'_episodes_' + timestamp + '.keras')
        self.target_network.save('model/' + env + '_Target_0.9_batch128_29000+' + numeps +'_episodes_' + timestamp + '.keras')
